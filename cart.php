                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary" style="background: #ffcbd3; border: none;">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
