            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4">
                        <h1 style="background:#ffcbd3; border: none; color: white;"><b>SIGN UP</b></h1>
                        <form method="post" action="user_registration_script.php">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary" value="Sign Up" style="background:#ffcbd3; border: none;">
                            </div>
                        </form>
                    </div>
                </div>
